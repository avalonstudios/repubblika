...
pll_register_string( 'repubblika', 'read more', 'rep_group' );
pll_register_string( 'repubblika', 'Event Type', 'rep_group' );

pll_register_string( 'repubblika', 'website', 'rep_group' );
pll_register_string( 'repubblika', 'Admittance', 'rep_group' );
pll_register_string( 'repubblika', 'Tickets', 'rep_group' );
pll_register_string( 'repubblika', 'phone', 'rep_group' );
pll_register_string( 'repubblika', 'Venue', 'rep_group' );
pll_register_string( 'repubblika', 'Details', 'rep_group' );
...
pll_register_string( 'repubblika', 'Dates &amp; Times', 'rep_group' );
pll_register_string( 'repubblika', 'View Events', 'rep_group' );
