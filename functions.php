<?php
/**
 * Repubblika functions and definitions
 *
...
if ( ! function_exists( 'repubblika_setup' ) ) :
	/**
	 ...
	 */
	function repubblika_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Repubblika, use a find and replace
		 * to change 'repubblika' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'repubblika', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'repubblika' ),
		) );
 ...
 */
function repubblika_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'repubblika_content_width', 640 );
}
add_action( 'after_setup_theme', 'repubblika_content_width', 0 );
...
function repubblika_scripts() {
	...
	wp_enqueue_script( 'repubblika-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'repubblika_scripts' );
...
pll_register_string( 'repubblika', 'test string', 'rep_group' );